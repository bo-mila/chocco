...
task('default', series('clean', parallel('copy:html', 'copy:img', 'copy:fonts', 'copy:video', 'styles', 'script'),
  parallel('watch', 'server')));

task('build', series('clean', parallel('copy:html', 'copy:img', 'copy:fonts', 'copy:video', 'styles', 'script')));