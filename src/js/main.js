  ...
  var placemarks = [
    {
      ...
      balloonContent: [
        ...
        '<img class="map__chocco-image" src="../img/content/boun.png" alt="Батончики"/>',
        'Самые вкусные батончики у нас! Заходите по адресу: ул.Литераторов, д.19',
        '</div>'
      ]
    },
    {
      ...
      balloonContent: [
        '<div class="map__balloon">',
        '<img class="map__chocco-image" src="../img/content/boun.png" alt="Батончики"/>',
        'Самые вкусные батончики у нас! Заходите по адресу: Малый проспект В О, д.64',
        '</div>'
      ]
    },
    {
      ...
      balloonContent: [
        '<div class="map__balloon">',
        '<img class="map__chocco-image" src="../img/content/boun.png" alt="Батончики"/>',
        'Самые вкусные батончики у нас! Заходите по адресу: наб.реки Фонтанки, д.56',
        '</div>'
      ]
    },
    {
